...
### Outputs a list of all players they have ever assisted, and the number of blocks to that player
### November 8, 2021
...
def getBlocks(siteurl):
    ...
    # a list of all blocks ever made
    ...
    strsearch = '(block by <a href="/players/' + myID[0] + '/' + myID + '.html">'
    for game in uniquegames:
        ...
        for line in gamesoup.find_all('td'):
            ...
            if str1.find(strsearch) > -1:
                ...
                blocklog.append(scorer)

    outdata = []
    scorers = set(blocklog)
    for player in scorers:
        blocks = blocklog.count(player)
...
##Embiid 
getBlocks("https://www.basketball-reference.com/players/e/embiijo01.html")
