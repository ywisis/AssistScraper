...
### Outputs a list of all players they have ever assisted, and the number of steals to that player
### November 8, 2021
...
def getSteals(siteurl):
    ...
    # a list of all steals ever made
    ...
    strsearch = 'steal by <a href="/players/' + myID[0] + '/' + myID + '.html">'
    for game in uniquegames:
        ...
        for line in gamesoup.find_all('td'):
            ...
            if str1.find(strsearch) > -1:
                ...
                steallog.append(scorer)

    outdata = []
    scorers = set(steallog)
    for player in scorers:
        steals = steallog.count(player)
...
##Mattise Thybulle
getSteals("https://www.basketball-reference.com/players/t/thybuma01.html")

## Ben Simmons
##getSteals("https://www.basketball-reference.com/players/s/simmobe01.html")

##Dame Lillard
##getSteals("https://www.basketball-reference.com/players/l/lillada01.html")

## Lebron James
#getSteals("https://www.basketball-reference.com/players/j/jamesle01.html")

## Jordan Poole
#getSteals("https://www.basketball-reference.com/players/p/poolejo01.html")

## Jerami Grant
#getSteals("https://www.basketball-reference.com/players/g/grantje01.html")

## Steph Curry
#getSteals("https://www.basketball-reference.com/players/c/curryst01.html")
